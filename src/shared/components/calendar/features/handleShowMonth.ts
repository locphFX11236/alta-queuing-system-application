...
import { MonthType } from '../type';

const ShowMonth = (rootDate: Moment): MonthType => {
    ...
    const currentMonth: MonthType = []; // Sẽ là mảng render thông tin tháng, chứa các mảng render thông tin tuần.
